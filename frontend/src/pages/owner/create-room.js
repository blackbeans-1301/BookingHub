            ...
            <div className="m-4 text-colorText">
              ...
              <div className="flex">
                ...
                <div className="text-colorText m-1 flex-1">
                  ...
                  />
                  <label for="ironing-facilities" className="text-colorText ml-2">
                    {" "}
                    Ironing facilities
                  </label>
                </div>
              ...
              <div className="flex">
                ...
                <div className="text-colorText m-1 flex-1">
                  ...
                  />
                  <label for="non-smoking-room" className="text-colorText ml-2">
                    {" "}
                    Non-smoking room
                  </label>
                </div>
            ...
            <div className="m-4 text-colorText">
              ...
              <div className="flex">
                ...
                <div className="text-colorText m-1 flex-1">
                  ...
                  />
                  <label for="currency-exchange" className="text-colorText ml-2">
                    {" "}
                    Currency exchange 
                  </label>
                </div>
