...
export default function SignUpModal({ isVisible, isClose }) {
        ...
        <div className="bg-white p-2 rounded flex flex-col m-2">
          ...
          <div>
            ...
            <div className="p-2 mb-4 flex justify-between">
              ...
              <label className="text-colorText" for="remember">Remember me</label>
              </div>
              
              <span className="font-bold text-light-primary hover:text-primary">Forgot password ?</span>
            </div>

          </div>
          <button type="submit" className="font-bold text-lg mb-4 pl-4 pr-4 bg-light-primary w-full text-colorText py-2 rounded-full hover:bg-primary hover:text-white">Login</button>
        
          <div className="mb-4 flex justify-center">
            <span>You don't have account ? </span> 
            <span className="font-bold text-light-primary hover:text-primary"> Sign up</span>
          </div>
        </div>
      </form>
    </div>
